...
<p style="text-align:right; margin-top:-20px; margin-right:10px; ">
    <a href="manage-shipper-tariff.php" style="color:#284c93; font-weight:bold;">
...
<td style="width:400px;">
    <p class="p5px ml10px">
     ...
     <select name="tariff_shipper_code" id="tariff_shipper_code" style="height:23px; width:180px;" onchange="get_ship_details(this.value);">
...
<td colspan="3">
   ...
   <select style="height:23px;" onchange="getArea(this.value)" name="basis_area_name" id="basis_area_name">
       <option value="">Select Area</option>
 <option value="Zone" <?php if($_REQUEST["edit_type"]=="Zone"){?>selected<?}?>>Zone</option>
       <option value="State" <?php if($_REQUEST["edit_type"]=="State"){?>selected<?}?>>State</option>
       <option value="City" <?php if($_REQUEST["edit_type"]=="City"){?>selected<?}?>>City</option>
 </select>

   <span id="show_zone_textfield" style="display:none;"></span>
   <span id="show_zone_textfield_bulk" style="display:none;"></span>
   
   <span id="show_state_textfield" style="display:none;"></span>
   <span id="show_state_textfield_bulk" style="display:none;"></span>
   
   <span id="show_city_textfield" style="display:none;"></span>
   <span id="show_city_textfield_bulk" style="display:none;"></span>
...
<?php if($_REQUEST["edit_type"]=="Zone"){?>
getArea("Zone");
<?}?>

<?php if($_REQUEST["edit_type"]=="State"){?>
getArea("State");
<?}?>

<?php if($_REQUEST["edit_type"]=="City"){?>
getArea("City");
<?}?>
    ...
    if(area_name!="")
{
        if(area_name=="Zone")
        {
            document.getElementById("show_state_textfield").style.display = "none";
            document.getElementById("show_state_textfield_bulk").style.display = "none";
            document.getElementById("show_city_textfield").style.display = "none";
            document.getElementById("show_city_textfield_bulk").style.display = "none";
                        document.getElementById("show_zone_textfield").style.display = "inline";
                        document.getElementById("show_zone_textfield_bulk").style.display = "inline";

            document.getElementById("show_zone_textfield").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enter number of row(s) for zone rate <input type='number' onkeyup='count_zone(this.value);' name='tariff_basis_zone' id='tariff_basis_zone' value='<?=$res[tariff_basis_zone]?>' style='height:23px; width:100px;' onkeydown='return event.keyCode !== 69'>";
            document.getElementById("show_zone_textfield_bulk").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enter number of row(s) for zone bulk rate <input type='number' onkeyup='count_zone_bulk(this.value);' value='<?=$res[tariff_basis_zone_bulk]?>' name='tariff_basis_zone_bulk' id='tariff_basis_zone_bulk' style='height:23px; width:100px;' onkeydown='return event.keyCode !== 69'>";
            count_state(0);
            count_city(0);
            count_state_bulk(0);
            count_city_bulk(0);
...
if(area_name=="State")
{
document.getElementById("show_zone_textfield").style.display = "none";
document.getElementById("show_zone_textfield_bulk").style.display = "none";
document.getElementById("show_city_textfield").style.display = "none";
document.getElementById("show_city_textfield_bulk").style.display = "none";
            document.getElementById("show_state_textfield").style.display = "inline";
            document.getElementById("show_state_textfield_bulk").style.display = "inline";

document.getElementById("show_state_textfield").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enter number of row(s) for state rate <input type='number' onkeyup='count_state(this.value);' name='tariff_basis_state' id='tariff_basis_state' value='<?=$res[tariff_basis_state]?>' style='height:23px; width:100px;' onkeydown='return event.keyCode !== 69'>";
document.getElementById("show_state_textfield_bulk").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enter number of row(s) for state bulk rate <input type='number' onkeyup='count_state_bulk(this.value);' name='tariff_basis_state_bulk' id='tariff_basis_state_bulk' value='<?=$res[tariff_basis_state_bulk]?>' style='height:23px; width:100px;' onkeydown='return event.keyCode !== 69'>";
count_zone(0);
count_zone_bulk(0);
count_city(0);
count_city_bulk(0);
            ...
            document.getElementById("show_zone_textfield").style.display = "none";
            document.getElementById("show_zone_textfield_bulk").style.display = "none";
                        document.getElementById("show_city_textfield").style.display = "inline";
                        document.getElementById("show_city_textfield_bulk").style.display = "inline";
            
            document.getElementById("show_city_textfield").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enter number of row(s) for city rate <input type='number' onkeyup='count_city(this.value);' name='tariff_basis_city' id='tariff_basis_city' value='<?=$res[tariff_basis_city]?>' style='height:23px; width:100px;' onkeydown='return event.keyCode !== 69'>";
            document.getElementById("show_city_textfield_bulk").innerHTML="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enter number of row(s) for city bulk rate <input type='number' onkeyup='count_city_bulk(this.value);' name='tariff_basis_city_bulk' id='tariff_basis_city_bulk' value='<?=$res[tariff_basis_city_bulk]?>' style='height:23px; width:100px;' onkeydown='return event.keyCode !== 69'>";
            count_zone(0);
            count_zone_bulk(0);
            count_state(0);
             count_state_bulk(0);
...
document.getElementById("show_city_textfield_bulk").style.display = "none";
        ...
        count_zone(0);
        document.getElementById("zone_bulk_heading").style.display = "none";
        document.getElementById("zone_bulk_charges_row1").style.display = "none";
        count_zone_bulk(0);
...
document.getElementById("state_bulk_heading").style.display = "none";
document.getElementById("state_bulk_charges_row1").style.display = "none";
count_state_bulk(0);
        ...
        document.getElementById("city_bulk_heading").style.display = "none";
        document.getElementById("city_bulk_charges_row1").style.display = "none";
        count_city_bulk(0);
...
function tariffValidation()
{
    var trf_shpr_code=document.getElementById("tariff_shipper_code").value;
       var trf_basis_area_name=document.getElementById("basis_area_name").value;
...
if(trf_volumetric_cft=="")
{
    ...
    if(trf_basis_area_name=="")
{
     alert("Please select basis !");
       $("#basis_area_name").focus();
     return false;
}
 ...
 document.getElementById("zone_row_line").style.display = "none";
  ...
  document.getElementById("show_zone_table").innerHTML="";
	...
	{ 
	    ...
	    var drop_down_zone_from="<select style='width:110px;' name='"+z_from+"' id='"+z_from+"'> <option value=''>Select Zone</option>";
...
<?}?>
       ...
       drop_down_zone_from+=drop_down_zone_content_from+"<option value='All'>All</option></select>";
       
       
       var drop_down_zone_to="<select style='width:110px;' name='"+z_to+"' id='"+z_to+"'> <option value=''>Select Zone</option>";
...
<?}?>
       ...
       drop_down_zone_to+=drop_down_zone_content_to+"<option value='All'>All</option></select>";
		...
		document.getElementById("show_zone_table").innerHTML+=' <tr style="border-top-style:solid; border-top-color:#284c93;"><td colspan="6"><b style="color:red;">S.N '+i+'</b></td></tr>  <tr style="border-top-style:solid; border-top-color:#284c93;">  <td><p class="b  blue ml20px p5px">From <br>'+drop_down_zone_from+'</p></td>        <td><p class="b  blue ml20px p5px">To <br>'+drop_down_zone_to+'</p></td>        <td><p class="b  blue ml20px p5px">Weight (In Grams) Upto <br><input type="number" name="zone_weight_'+i+'" id="zone_weight_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>            <td><p class="b  blue ml20px p5px">Rate <br><input type="number" name="zone_rate_'+i+'" id="zone_rate_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>  <td><p class="b  blue ml20px p5px">Additional Weight (In Grams)<br><input type="number" name="zone_add_weight_'+i+'" id="zone_add_weight_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>   <td><p class="b  blue ml20px p5px">Additional Charge <br><input type="number" name="zone_add_charge'+i+'" id="zone_add_charge'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>  </tr> ';
...
/*ZONE BULK RATE ROWS START*/ 
 function count_zone_bulk(zone_bulk_count)
{
    var cou=parseInt(zone_bulk_count);
    

 if(zone_bulk_count=="" || zone_bulk_count==0){
 document.getElementById("zone_bulk_heading").style.display = "none";
 }else{
   document.getElementById("zone_bulk_heading").style.display = "block";
 }
 ...
 document.getElementById("zone_bulk_charges_row1").style.display = "none";
  ...
  document.getElementById("zone_bulk_charges_row1").style.display = "block";
...
/*   document.getElementById("zone_row_line").style.display = "block";
 ...
 document.getElementById("zone_row_line").style.display = "none";
  ...
  document.getElementById("show_zone_bulk_table").innerHTML="";
 
	for(var i=1; i<=cou; i++)
	{ 
	    var z_from="zone_bulk_from_"+i;
	     var z_to="zone_bulk_to_"+i;

	    var drop_down_zone_bulk_from="<select name='"+z_from+"' id='"+z_from+"'> <option value=''>Select Zone</option>";
	    var drop_down_zone_bulk_content_from="";
	   <?php
	   $tariff_zone_from_sql=db_query("select * from tbl_zone WHERE zone_status = 'Active'");
            while($tariff_zone_from_res=mysql_fetch_array($tariff_zone_from_sql)){
        ?>
        drop_down_zone_bulk_content_from+="<option value='<?=$tariff_zone_from_res[zone_name]?>'> <?=$tariff_zone_from_res[zone_name]?> </option>";

<?}?>
        
       drop_down_zone_bulk_from+=drop_down_zone_bulk_content_from+"<option value='All'>All</option></select>";
       
       
       var drop_down_zone_bulk_to="<select name='"+z_to+"' id='"+z_to+"'> <option value=''>Select Zone</option>";
	    var drop_down_zone_bulk_content_to="";
	   <?php
	   $tariff_zone_to_sql=db_query("select * from tbl_zone WHERE zone_status = 'Active'");
            while($tariff_zone_to_res=mysql_fetch_array($tariff_zone_to_sql)){
        ?>
        drop_down_zone_bulk_content_to+="<option value='<?=$tariff_zone_to_res[zone_name]?>'> <?=$tariff_zone_to_res[zone_name]?> </option>";

<?}?>
        
       drop_down_zone_bulk_to+=drop_down_zone_bulk_content_to+"<option value='All'>All</option></select>";
		...
		document.getElementById("show_zone_bulk_table").innerHTML+=' <tr style="border-top-style:solid; border-top-color:#284c93;"><td colspan="5"><b style="color:red;">S.N '+i+'</b></td></tr>  <tr style="border-top-style:solid; border-top-color:#284c93;">  <td><p class="b  blue ml20px p5px">From <br>'+drop_down_zone_bulk_from+'</p></td>        <td><p class="b  blue ml20px p5px">To <br>'+drop_down_zone_bulk_to+'</p></td>        <td><p class="b  blue ml20px p5px">Weight (In Grams) Upto <br><input type="number" name="zone_bulk_weight_'+i+'" id="zone_bulk_weight_'+i+'" onkeydown="return event.keyCode !== 69" style="width:150px;"></p></td>        <td><p class="b  blue ml20px p5px">Rate <br><input type="number" name="zone_bulk_rate_'+i+'" id="zone_bulk_rate_'+i+'" onkeydown="return event.keyCode !== 69" style="width:150px;"></p></td>    </tr> ';
...
document.getElementById("show_state_table").innerHTML="";
  ...
  var drop_down_state_from="<select style='width:110px;' name='"+s_from+"' id='"+s_from+"'> <option value=''>Select State</option>";
...
<?}?>
  ...
  var drop_down_state_to="<select style='width:110px;' name='"+s_to+"' id='"+s_to+"'> <option value=''>Select State</option>";
...
<?}?>
       ...
       drop_down_state_to+=drop_down_state_content_to+"</select>";
		...
		document.getElementById("show_state_table").innerHTML+='    <tr style="border-top-style:solid; border-top-color:#284c93;"><td colspan="6"><b style="color:red;">S.N '+i+'</b></td></tr>  <tr style="border-top-style:solid; border-top-color:#284c93;">  <td><p class="b  blue ml20px p5px">From <br>'+drop_down_state_from+'</p></td>        <td><p class="b  blue ml20px p5px">To <br>'+drop_down_state_to+'</p></td>        <td><p class="b  blue ml20px p5px">Weight (In Grams) Upto <br><input type="number" name="state_weight_'+i+'" id="state_weight_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>        <td><p class="b  blue ml20px p5px">Rate <br><input type="number" name="state_rate_'+i+'" id="state_rate_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>            <td><p class="b  blue ml20px p5px">Additional Weight <br><input type="number" name="state_add_weight_'+i+'" id="state_add_weight_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>        <td><p class="b  blue ml20px p5px">Additional Charge <br><input type="number" name="state_add_charge_'+i+'" id="state_add_charge_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td> </tr>';
...
/*STATE BULK RATE START*/
    function count_state_bulk(state_bulk_count)
{
	var coub=parseInt(state_bulk_count);
 
 if(state_bulk_count=="" || state_bulk_count==0){
 document.getElementById("state_bulk_heading").style.display = "none";
 }else{
     document.getElementById("state_bulk_heading").style.display = "block";
 }
 ...
 document.getElementById("state_bulk_charges_row1").style.display = "none";
       ...
       document.getElementById("state_bulk_charges_row1").style.display = "block";
...
document.getElementById("show_state_bulk_table").innerHTML="";
	for(var i=1; i<=coub; i++)
	{
	     var s_bulk_from="state_bulk_from_"+i;
	     var s_bulk_to="state_bulk_to_"+i;
	    
  var drop_down_state_bulk_from="<select name='"+s_bulk_from+"' id='"+s_bulk_from+"'> <option value=''>Select State</option>";
	    var drop_down_state_bulk_content_from="";
	   <?php
	   $tariff_state_sql=db_query("select * from tbl_state_master WHERE state_status = 'Active'");
            while($tariff_state_res=mysql_fetch_array($tariff_state_sql)){
        ?>
        drop_down_state_bulk_content_from+="<option value='<?=$tariff_state_res[state_name]?>'> <?=$tariff_state_res[state_name]?> </option>";

<?}?>
        
       drop_down_state_bulk_from+=drop_down_state_bulk_content_from+"</select>";
       
       
       
  var drop_down_state_bulk_to="<select name='"+s_bulk_to+"' id='"+s_bulk_to+"'> <option value=''>Select State</option>";
	    var drop_down_state_bulk_content_to="";
	   <?php
	   $tariff_state_sql=db_query("select * from tbl_state_master WHERE state_status = 'Active'");
            while($tariff_state_res=mysql_fetch_array($tariff_state_sql)){
        ?>
        drop_down_state_bulk_content_to+="<option value='<?=$tariff_state_res[state_name]?>'> <?=$tariff_state_res[state_name]?> </option>";

<?}?>
        
       drop_down_state_bulk_to+=drop_down_state_bulk_content_to+"</select>";
       
       
       
       
       
		document.getElementById("show_state_bulk_table").innerHTML+='    <tr style="border-top-style:solid; border-top-color:#284c93;"><td colspan="5"><b style="color:red;">S.N '+i+'</b></td></tr>  <tr style="border-top-style:solid; border-top-color:#284c93;">  <td><p class="b  blue ml20px p5px">From <br>'+drop_down_state_bulk_from+'</p></td>        <td><p class="b  blue ml20px p5px">To <br>'+drop_down_state_bulk_to+'</p></td>        <td><p class="b  blue ml20px p5px">Weight (In Grams) Upto <br><input type="number" name="state_bulk_weight_'+i+'" id="state_bulk_weight_'+i+'" onkeydown="return event.keyCode !== 69" style="width:150px;"></p></td>        <td><p class="b  blue ml20px p5px">Rate <br><input type="number" name="state_bulk_rate_'+i+'" id="state_bulk_rate_'+i+'" onkeydown="return event.keyCode !== 69" style="width:150px;"></p></td>    </tr>';
...
var drop_down_city_from="<select style='width:110px;' name='"+c_from+"' id='"+c_from+"'> <option value=''>Select City</option>";
...
var drop_down_city_to="<select style='width:110px;' name='"+c_to+"' id='"+c_to+"'> <option value=''>Select City</option>";
...
<?}?>
       ...
       drop_down_city_to+=drop_down_city_content_to+"</select>";
		...
		document.getElementById("show_city_table").innerHTML+='  <tr style="border-top-style:solid; border-top-color:#284c93;"><td colspan="6"><b style="color:red;">S.N '+i+'</b></td></tr>  <tr style="border-top-style:solid; border-top-color:#284c93;">  <td><p class="b  blue ml20px p5px">From <br>'+drop_down_city_from+'</p></td>        <td><p class="b  blue ml20px p5px">To <br>'+drop_down_city_to+'</p></td>        <td><p class="b  blue ml20px p5px">Weight (In Grams) Upto <br><input type="number" name="city_weight_'+i+'" id="city_weight_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>        <td><p class="b  blue ml20px p5px">Rate <br><input type="number" name="city_rate_'+i+'" id="city_rate_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>   <td><p class="b  blue ml20px p5px">Additional  Weight<br><input type="number" name="city_add_weight_'+i+'" id="city_add_weight_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>        <td><p class="b  blue ml20px p5px">Additional Charge <br><input type="number" name="city_add_charge_'+i+'" id="city_add_charge_'+i+'" onkeydown="return event.keyCode !== 69" style="width:70px;"></p></td>  </tr> '; 
		}
	
}

/*CITY BULK RATE START*/
 function count_city_bulk(city_bulk_count)
{

	var cou=parseInt(city_bulk_count);

 
 if(city_bulk_count=="" || city_bulk_count==0){
 document.getElementById("city_bulk_heading").style.display = "none";
 }else{
     document.getElementById("city_bulk_heading").style.display = "block";
 }
 ...
 document.getElementById("city_bulk_charges_row1").style.display = "none";
      ...
      document.getElementById("city_bulk_charges_row1").style.display = "block";
...
document.getElementById("show_city_bulk_table").innerHTML="";
	for(var i=1; i<=cou; i++)
	{
	     var c_bulk_from="city_bulk_from_"+i;
	     var c_bulk_to="city_bulk_to_"+i;
	     
var drop_down_city_bulk_from="<select name='"+c_bulk_from+"' id='"+c_bulk_from+"'> <option value=''>Select City</option>";
	    var drop_down_city_bulk_content_from="";
	   <?php
	   $tariff_city_sql=db_query("select * from tbl_city_master WHERE city_status = 'Active'");
            while($tariff_city_res=mysql_fetch_array($tariff_city_sql)){
        ?>
        drop_down_city_bulk_content_from+="<option value='<?=$tariff_city_res[city_name]?>'> <?=$tariff_city_res[city_name]?> </option>";

<?}?>
        
       drop_down_city_bulk_from+=drop_down_city_bulk_content_from+"</select>";
       
       
var drop_down_city_bulk_to="<select name='"+c_bulk_to+"' id='"+c_bulk_to+"'> <option value=''>Select City</option>";
	    var drop_down_city_bulk_content_to="";
	   <?php
	   $tariff_city_sql=db_query("select * from tbl_city_master WHERE city_status = 'Active'");
            while($tariff_city_res=mysql_fetch_array($tariff_city_sql)){
        ?>
        drop_down_city_bulk_content_to+="<option value='<?=$tariff_city_res[city_name]?>'> <?=$tariff_city_res[city_name]?> </option>";

<?}?>
        
       drop_down_city_bulk_to+=drop_down_city_bulk_content_to+"</select>";
       
       
	   
		document.getElementById("show_city_bulk_table").innerHTML+='  <tr style="border-top-style:solid; border-top-color:#284c93;"><td colspan="5"><b style="color:red;">S.N '+i+'</b></td></tr>  <tr style="border-top-style:solid; border-top-color:#284c93;">  <td><p class="b  blue ml20px p5px">From <br>'+drop_down_city_bulk_from+'</p></td>        <td><p class="b  blue ml20px p5px">To <br>'+drop_down_city_bulk_to+'</p></td>        <td><p class="b  blue ml20px p5px">Weight (In Grams) Upto <br><input type="number" name="city_bulk_weight_'+i+'" id="city_bulk_weight_'+i+'" onkeydown="return event.keyCode !== 69" style="width:150px;"></p></td>        <td><p class="b  blue ml20px p5px">Rate <br><input type="number" name="city_bulk_rate_'+i+'" id="city_bulk_rate_'+i+'" onkeydown="return event.keyCode !== 69" style="width:150px;"></p></td>    </tr> '; 
		}
...
<td colspan="4">
  ...
  <h3 style="color:black; font-weight:bold; text-align:center;<?php if($update_id!="" && $res['tariff_basis_zone']!=0 && $_REQUEST["edit_type"]=="Zone"){?>display:block;<?}else{?>display:none;<?}?>" id="zone_heading">Zone Rate</h3>
<!--<p class="bdr0 m5px mr30px" id="zone_row_line" style="display:none;"></p>-->
  
  <p id="zone_charges_row" class="b  blue  p5px" style="<?php if($update_id!="" && $res['tariff_basis_zone']!=0 && $_REQUEST["edit_type"]=="Zone"){?>display:block;<?}else{?>display:none;<?}?>">
  ...
  <p id="zone_charges_row1" class="b  blue  p5px" style="<?php if($update_id!="" && $res['tariff_basis_zone']!=0 && $_REQUEST["edit_type"]=="Zone"){?>display:block;<?}else{?>display:none;<?}?>">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Handling Charge <input type="number" name="zone_handling_charge" id="zone_handling_charge" value="<?=$res['zone_handling_charge']?>" onkeydown="return event.keyCode !== 69" style="width:129px;"> 
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Any Other Charge <input type="number" name="zone_other_charge" id="zone_other_charge" value="<?=$res['zone_other_charge']?>" onkeydown="return event.keyCode !== 69" style="width:118px;">
<!--    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Additional Weight <input type="number" name="zone_additional_weight" id="zone_additional_weight" value="<?=$res['zone_additional_weight']?>" onkeydown="return event.keyCode !== 69" style="width:119px;"> 
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Remarks <input type="text" name="zone_remarks" id="zone_remarks" value="<?=$res['zone_remarks']?>" style="width:172px;"> 
        </p>
...
<table id="show_zone_table" width="100%">
  ...
  <?php
if($_REQUEST["edit_type"]=="Zone")
{
?>  
<?php //for($i=1; $i<=$res['tariff_basis_zone']; $i++){
$zoneSQL=db_query("select * from tbl_tariff_rate where tariff_id='$res[tariff_id]' and rate_type='Zone' and rate_is_normal='Normal' and rate_is_bulk='' order by tariff_rate_id asc");
...
$drop_down_zone_from="<select style='width:110px;' name='".$z_from."' id='".$z_from."'> <option value=''>Select Zone</option>";
$drop_down_zone_content_from="";
	   ...
	   $tariff_zone_sql_from=db_query("select * from tbl_zone WHERE zone_status = 'Active'");
        ...
        {
           $select="selected"; 
        }else if($zoneRES['tariff_from']=="All"){
        $select12="selected"; 
        }else{
            $select="";
        }
       ...
       $drop_down_zone_from.=$drop_down_zone_content_from."<option value='All' $select12>All</option></select>";
    
       
       
          $select="";
$drop_down_zone_to="<select style='width:110px;' name='".$z_to."' id='".$z_to."'> <option value=''>Select Zone</option>";
$drop_down_zone_content_to="";
       ...
       $drop_down_zone_to.=$drop_down_zone_content_to."<option value='All' $select11>All</option></select>";
...
<br>
<input type="number" name="zone_weight_<?=$i?>" id="zone_weight_<?=$i?>" value="<?=$zoneRES['weight_upto']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td> 
<td>
<p class="b  blue ml20px p5px">
Rate
<br>
<input type="number" name="zone_rate_<?=$i?>" id="zone_rate_<?=$i?>" value="<?=$zoneRES['rate']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td>  
...
Additional Weight
<br>
<input type="number" name="zone_add_weight_<?=$i?>" id="zone_add_weight_<?=$i?>" value="<?=$zoneRES['tariff_additional_weight']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td> 
<td>
<p class="b  blue ml20px p5px">
Additional Charge
<br>
<input type="number" name="zone_add_charge<?=$i?>" id="zone_add_charge<?=$i?>" value="<?=$zoneRES['tariff_additional_charge']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td>
</tr>
...
<!--ZONE BULK RATE HEADING START-->
<tr>
<td colspan="4">
   
  
  <h3 style="color:black; font-weight:bold; text-align:center;<?php if($update_id!="" && $res['tariff_basis_zone_bulk']!=0 && $_REQUEST["edit_type"]=="Zone"){?>display:block;<?}else{?>display:none;<?}?>" id="zone_bulk_heading">Zone Bulk Rate</h3>
<!--<p class="bdr0 m5px mr30px" id="zone_row_line" style="display:none;"></p>-->

  <p id="zone_bulk_charges_row1" class="b  blue  p5px" style="<?php if($update_id!="" && $res['tariff_basis_zone_bulk']!=0 && $_REQUEST["edit_type"]=="Zone"){?>display:block;<?}else{?>display:none;<?}?>">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Additional Weight <input type="number" name="zone_bulk_additional_weight" id="zone_bulk_additional_weight" value="<?=$res['zone_bulk_additional_weight']?>" onkeydown="return event.keyCode !== 69" style="width:119px;"> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Additional Charge <input type="number" name="zone_bulk_additional_charge" id="zone_bulk_additional_charge" value="<?=$res['zone_bulk_additional_charge']?>" onkeydown="return event.keyCode !== 69" style="width:120px;"> 
        </p>
        


<table id="show_zone_bulk_table" width="100%">
...
?>  
<?php 
$zoneSQL=db_query("select * from tbl_tariff_rate where tariff_id='$res[tariff_id]' and rate_type='Zone' and rate_is_normal='' and rate_is_bulk='Bulk' order by tariff_rate_id asc");
...
$z_from="zone_bulk_from_".$ibulk;
$z_to="zone_bulk_to_".$ibulk;
	     $select="";
	     $select12="";
	     $select11="";
	     
	     
$drop_down_zone_bulk_from="<select name='".$z_from."' id='".$z_from."'> <option value=''>Select Zone</option>";
$drop_down_zone_bulk_content_from="";
	   ...
	   $tariff_zone_sql_from=db_query("select * from tbl_zone WHERE zone_status = 'Active'");
        ...
        $drop_down_zone_bulk_content_from.="<option value='$tariff_zone_res_from[zone_name]' $select> $tariff_zone_res_from[zone_name] </option>";
 

}
        
       $drop_down_zone_bulk_from.=$drop_down_zone_bulk_content_from."<option value='All' $select12>All</option></select>";
    
       
       
          $select="";
$drop_down_zone_bulk_to="<select name='".$z_to."' id='".$z_to."'> <option value=''>Select Zone</option>";
$drop_down_zone_bulk_content_to="";
	   ...
	   $tariff_zone_sql_to=db_query("select * from tbl_zone WHERE zone_status = 'Active'");
        ...
        $drop_down_zone_bulk_content_to.="<option value='$tariff_zone_res_to[zone_name]' $select> $tariff_zone_res_to[zone_name] </option>";
    

}
        
       $drop_down_zone_bulk_to.=$drop_down_zone_bulk_content_to."<option value='All' $select11>All</option></select>";
...
Weight (In Grams) Upto
<br>
<input type="number" name="zone_bulk_weight_<?=$ibulk?>" id="zone_bulk_weight_<?=$ibulk?>" value="<?=$zoneRES['weight_upto']?>" onkeydown="return event.keyCode !== 69" style="width:150px;">
</p>
</td> 
<td>
<p class="b  blue ml20px p5px">
Rate
<br>
<input type="number" name="zone_bulk_rate_<?=$ibulk?>" id="zone_bulk_rate_<?=$ibulk?>" value="<?=$zoneRES['rate']?>" onkeydown="return event.keyCode !== 69" style="width:150px;">
</p>
</td>    
</tr>
...
<!--ZONE BULK RATE HEADING END-->


<tr>
<td colspan="4">
    
  <h3 style="color:black; font-weight:bold; text-align:center;<?php if($update_id!="" && $res['tariff_basis_state']!=0 && $_REQUEST["edit_type"]=="State"){?>display:block;<?}else{?>display:none;<?}?>" id="state_heading">State Rate</h3>
<!--<p class="bdr0 m5px mr30px" id="state_row_line" style="display:none;"></p>-->
  
  <p id="state_charges_row" class="b  blue  p5px" style="<?php if($update_id!="" && $res['tariff_basis_state']!=0 && $_REQUEST["edit_type"]=="State"){?>display:block;<?}else{?>display:none;<?}?>">
  ...
  <p id="state_charges_row1" class="b  blue  p5px" style="<?php if($update_id!="" && $res['tariff_basis_state']!=0 && $_REQUEST["edit_type"]=="State"){?>display:block;<?}else{?>display:none;<?}?>">
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Handling Charge <input type="number" name="state_handling_charge" id="state_handling_charge" value="<?=$res['state_handling_charge']?>" onkeydown="return event.keyCode !== 69" style="width:129px;"> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Any Other Charge <input type="number" name="state_other_charge" id="state_other_charge" value="<?=$res['state_other_charge']?>" onkeydown="return event.keyCode !== 69" style="width:118px;">
...
-->    
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Remarks <input type="text" name="state_remarks" id="state_remarks" value="<?=$res['state_remarks']?>" style="width:172px;"> 
        </p>
...
<table id="show_state_table" width="100%">
      <?php
if($_REQUEST["edit_type"]=="State")
{
?> 
<?php
$stateSQL=db_query("select * from tbl_tariff_rate where tariff_id='$res[tariff_id]' and rate_type='State' and rate_is_normal='Normal' and rate_is_bulk='' order by tariff_rate_id asc");
...
$drop_down_state_from="<select style='width:110px;' name='".$s_from."' id='".$s_from."'> <option value=''>Select State</option>";
...
$drop_down_state_to="<select style='width:110px;' name='".$s_to."' id='".$s_to."'> <option value=''>Select State</option>";
...
Weight (In Grams) Upto
<br>
<input type="number" name="state_weight_<?=$j?>" id="state_weight_<?=$j?>" value="<?=$stateRES['weight_upto']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td> 
<td>
<p class="b  blue ml20px p5px">
Rate
<br>
<input type="number" name="state_rate_<?=$j?>" id="state_rate_<?=$j?>" value="<?=$stateRES['rate']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td>  
...
Additional Weight
<br>
<input type="number" name="state_add_weight_<?=$j?>" id="state_add_weight_<?=$j?>" value="<?=$stateRES['tariff_additional_weight']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td> 
<td>
<p class="b  blue ml20px p5px">
Additional Charge
<br>
<input type="number" name="state_add_charge_<?=$j?>" id="state_add_charge_<?=$j?>" value="<?=$stateRES['tariff_additional_charge']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td>  
</tr>
...
<!--STATE BULK ROWS START-->
<tr>
<td colspan="4">
    
  <h3 style="color:black; font-weight:bold; text-align:center;<?php if($update_id!="" && $res['tariff_basis_state_bulk']!=0 && $_REQUEST["edit_type"]=="State"){?>display:block;<?}else{?>display:none;<?}?>" id="state_bulk_heading">State Bulk Rate</h3>
<!--<p class="bdr0 m5px mr30px" id="state_row_line" style="display:none;"></p>-->
  



  <p id="state_bulk_charges_row1" class="b  blue  p5px" style="<?php if($update_id!="" && $res['tariff_basis_state_bulk']!=0 && $_REQUEST["edit_type"]=="State"){?>display:block;<?}else{?>display:none;<?}?>">

      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Additional Weight <input type="number" name="state_bulk_additional_weight" id="state_bulk_additional_weight" value="<?=$res['state_bulk_additional_weight']?>" onkeydown="return event.keyCode !== 69" style="width:119px;"> 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Additional Charge <input type="number" name="state_bulk_additional_charge" id="state_bulk_additional_charge" value="<?=$res['state_bulk_additional_charge']?>" onkeydown="return event.keyCode !== 69" style="width:120px;">

        </p>
      
     
  
<table id="show_state_bulk_table" width="100%">
      <?php
if($_REQUEST["edit_type"]=="State")
{
?> 
<?php
$stateSQL=db_query("select * from tbl_tariff_rate where tariff_id='$res[tariff_id]' and rate_type='State' and rate_is_normal='' and rate_is_bulk='Bulk' order by tariff_rate_id asc");
...
$s_bulk_from="state_bulk_from_".$j_bulk;
$s_bulk_to="state_bulk_to_".$j_bulk;
	    $select="";
	    
$drop_down_state_bulk_from="<select name='".$s_bulk_from."' id='".$s_bulk_from."'> <option value=''>Select State</option>";
$drop_down_state_bulk_content_from="";
	   ...
	   $tariff_state_sql_from=db_query("select * from tbl_state_master WHERE state_status = 'Active'");
        ...
        $drop_down_state_bulk_content_from.="<option value='$tariff_state_res_from[state_name]' $select> $tariff_state_res_from[state_name] </option>";
...
$drop_down_state_bulk_to="<select name='".$s_bulk_to."' id='".$s_bulk_to."'> <option value=''>Select State</option>";
$drop_down_state_bulk_content_to="";
	   ...
	   $tariff_state_sql_to=db_query("select * from tbl_state_master WHERE state_status = 'Active'");
        ...
        $drop_down_state_bulk_content_to.="<option value='$tariff_state_res_to[state_name]' $select> $tariff_state_res_to[state_name] </option>";
...
Weight (In Grams) Upto
<br>
<input type="number" name="state_bulk_weight_<?=$j_bulk?>" id="state_bulk_weight_<?=$j_bulk?>" value="<?=$stateRES['weight_upto']?>" onkeydown="return event.keyCode !== 69" style="width:150px;">
</p>
</td> 
<td>
<p class="b  blue ml20px p5px">
Rate
<br>
<input type="number" name="state_bulk_rate_<?=$j_bulk?>" id="state_bulk_rate_<?=$j_bulk?>" value="<?=$stateRES['rate']?>" onkeydown="return event.keyCode !== 69" style="width:150px;">
</p>
</td>    
</tr>
...
<td colspan="4">
  ...
  <h3 style="color:black; font-weight:bold; text-align:center;<?php if($update_id!="" && $res['tariff_basis_city']!=0 && $_REQUEST["edit_type"]=="City"){?>display:block;<?}else{?>display:none;<?}?>" id="city_heading">City Rate</h3>
<!--<p class="bdr0 m5px mr30px" id="city_row_line" style="display:none;"></p>-->
  
  <p id="city_charges_row" class="b  blue  p5px" style="<?php if($update_id!="" && $res['tariff_basis_city']!=0 && $_REQUEST["edit_type"]=="City"){?>display:block;<?}else{?>display:none;<?}?>">
      ...
      <p id="city_charges_row1" class="b  blue  p5px" style="<?php if($update_id!="" && $res['tariff_basis_city']!=0 && $_REQUEST["edit_type"]=="City"){?>display:block;<?}else{?>display:none;<?}?>">
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Handling Charge <input type="number" name="city_handling_charge" id="city_handling_charge" value="<?=$res['city_handling_charge']?>" onkeydown="return event.keyCode !== 69" style="width:129px;"> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Any Other Charge <input type="number" name="city_other_charge" id="city_other_charge" value="<?=$res['city_other_charge']?>" onkeydown="return event.keyCode !== 69" style="width:118px;">
<!--      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Additional Weight <input type="number" name="city_additional_weight" id="city_additional_weight" value="<?=$res['city_additional_weight']?>" onkeydown="return event.keyCode !== 69" style="width:119px;"> 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Remarks <input type="text" name="city_remarks" id="city_remarks" value="<?=$res['city_remarks']?>" style="width:172px;"> 
        </p>
...
<table id="show_city_table" width="100%">
      <?php
if($_REQUEST["edit_type"]=="City")
{
?> 
<?php
$citySQL=db_query("select * from tbl_tariff_rate where tariff_id='$res[tariff_id]' and rate_type='City' and rate_is_normal='Normal' and rate_is_bulk='' order by tariff_rate_id asc");
...
$drop_down_city_from="<select style='width:110px;' name='".$c_from."' id='".$c_from."'> <option value=''>Select City</option>";
...
$drop_down_city_to="<select style='width:110px;' name='".$c_to."' id='".$c_to."'> <option value=''>Select City</option>";
...
Weight (In Grams) Upto
<br>
<input type="number" name="city_weight_<?=$k?>" id="city_weight_<?=$k?>" value="<?=$cityRES['weight_upto']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td> 
<td>
<p class="b  blue ml20px p5px">
Rate
<br>
<input type="number" name="city_rate_<?=$k?>" id="city_rate_<?=$k?>" value="<?=$cityRES['rate']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td>   
...
Additional Weight
<br>
<input type="number" name="city_add_weight_<?=$k?>" id="city_add_weight_<?=$k?>" value="<?=$cityRES['tariff_additional_weight']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td> 
<td>
<p class="b  blue ml20px p5px">
Additional Charge
<br>
<input type="number" name="city_add_charge_<?=$k?>" id="city_add_charge_<?=$k?>" value="<?=$cityRES['tariff_additional_charge']?>" onkeydown="return event.keyCode !== 69" style="width:70px;">
</p>
</td>  
</tr>
...
<td colspan="4">
  ...
  <h3 style="color:black; font-weight:bold; text-align:center;<?php if($update_id!="" && $res['tariff_basis_city_bulk']!=0 && $_REQUEST["edit_type"]=="City"){?>display:block;<?}else{?>display:none;<?}?>" id="city_bulk_heading">City Bulk Rate</h3>
<!--<p class="bdr0 m5px mr30px" id="city_row_line" style="display:none;"></p>-->

    
    
      <p id="city_bulk_charges_row1" class="b  blue  p5px" style="<?php if($update_id!="" && $res['tariff_basis_city_bulk']!=0 && $_REQUEST["edit_type"]=="City"){?>display:block;<?}else{?>display:none;<?}?>">

      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Additional Weight <input type="number" name="city_bulk_additional_weight" id="city_bulk_additional_weight" value="<?=$res['city_bulk_additional_weight']?>" onkeydown="return event.keyCode !== 69" style="width:119px;"> 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Additional Charge <input type="number" name="city_bulk_additional_charge" id="city_bulk_additional_charge" value="<?=$res['city_bulk_additional_charge']?>" onkeydown="return event.keyCode !== 69" style="width:120px;">
...
<table id="show_city_bulk_table" width="100%">
      <?php
if($_REQUEST["edit_type"]=="City")
{
?> 
<?php
$citySQL=db_query("select * from tbl_tariff_rate where tariff_id='$res[tariff_id]' and rate_type='City' and rate_is_normal='' and rate_is_bulk='Bulk' order by tariff_rate_id asc");
...
$c_bulk_from="city_bulk_from_".$k_bulk;
$c_bulk_to="city_bulk_to_".$k_bulk;
	    
	    $select="";
	    
$drop_down_city_bulk_from="<select name='".$c_bulk_from."' id='".$c_bulk_from."'> <option value=''>Select City</option>";
$drop_down_city_bulk_content_from="";
	   ...
	   $tariff_city_sql_from=db_query("select * from tbl_city_master WHERE city_status = 'Active'");
        ...
        $drop_down_city_bulk_content_from.="<option value='$tariff_city_res_from[city_name]' $select> $tariff_city_res_from[city_name] </option>";
...
$drop_down_city_bulk_to="<select name='".$c_bulk_to."' id='".$c_bulk_to."'> <option value=''>Select City</option>";
$drop_down_city_bulk_content_to="";
	   ...
	   $tariff_city_sql_to=db_query("select * from tbl_city_master WHERE city_status = 'Active'");
        ...
        $drop_down_city_bulk_content_to.="<option value='$tariff_city_res_to[city_name]' $select> $tariff_city_res_to[city_name] </option>";
...
Weight (In Grams) Upto
<br>
<input type="number" name="city_bulk_weight_<?=$k_bulk?>" id="city_bulk_weight_<?=$k_bulk?>" value="<?=$cityRES['weight_upto']?>" onkeydown="return event.keyCode !== 69" style="width:150px;">
</p>
</td> 
<td>
<p class="b  blue ml20px p5px">
Rate
<br>
<input type="number" name="city_bulk_rate_<?=$k_bulk?>" id="city_bulk_rate_<?=$k_bulk?>" value="<?=$cityRES['rate']?>" onkeydown="return event.keyCode !== 69" style="width:150px;">
</p>
</td>    
</tr>
...
<script>
function get_ship_details(sh_code)
{
$.ajax({
type: "POST",
url: "get_tariff_ship_details.php",
data: {sh_code:sh_code},
cache: false,
success: function(result){

var fetch_data=JSON.parse(result);
document.getElementById('tariff_client_name').value=fetch_data.ship_name;
document.getElementById('tariff_service_tax').value=fetch_data.ship_tax_rate;
document.getElementById('tariff_address').value=fetch_data.ship_address;
$('#tariff_trans_mode option[value='+fetch_data.ship_mode+']').attr('selected','selected');
document.getElementById('tariff_fov').value=fetch_data.ship_fov;
document.getElementById('tariff_min').value=fetch_data.ship_fov_min;
document.getElementById('tariff_volumetric').value=fetch_data.ship_volu;
...
count_state_bulk(0);
       ...
       document.getElementById("city_bulk_heading").style.display = "none";
        document.getElementById("city_bulk_charges_row1").style.display = "none";
        count_city_bulk(0);
        $("#basis_area_name option[value='']").attr('selected','selected');
   ...
   $(document).ready(function(){
       $('#basis_area_name').change(function(){
        var tariff_shipper_code=$('#tariff_shipper_code').val();
        var basis_area_name=$('#basis_area_name').val();
        
      $.ajax({
            url:"check_duplicate.php",
            type:"POST",
            data:{tariff_shipper_code:tariff_shipper_code, basis_area_name:basis_area_name, type:"TARIFF"},
            success:function(data){
       
                if(data!=""){
                     var con_value="";
                    con_value=confirm(" This basis is already exist !\n Would you like to modify ?");
                    
                    if(con_value==true)
                    {
                        
                        window.location.href="manage-shipper-tariff.php"+data;
                    }else{
                    $('#tariff_submit').attr("disabled","disabled");
                    $('#tariff_submit').css({"cursor":"no-drop"});
                    
                    $('#tariff_basis_zone').css({"display":"none"});
                    $('#tariff_basis_zone_bulk').css({"display":"none"});

                    $('#tariff_basis_state').css({"display":"none"});
                    $('#tariff_basis_state_bulk').css({"display":"none"});
                    
                    $('#tariff_basis_city').css({"display":"none"});
                    $('#tariff_basis_city_bulk').css({"display":"none"});
                    }
...
*/ $i = 0; 
$sql=db_query("select * from tbl_tariff where 1 $cond order by tariff_id desc");
...
<select name="edit_option" id="edit_option" onchange="EditOption(this.value,'<?=$res1[tariff_id]?>');" style="width:60px;">
<option value="">Edit</option>
<?php
$trf_Edit_sql=db_query("select distinct(rate_type) from tbl_tariff_rate where tariff_id='$res1[tariff_id]' order by rate_type asc");
while($trf_Edit_res=mysql_fetch_array($trf_Edit_sql))
{
?>
<option value="<?=$trf_Edit_res['rate_type']?>" <?php if($_REQUEST['edit_type']==$trf_Edit_res['rate_type'] && $res1['tariff_id']==$update_id){?>selected<?}?>><?=$trf_Edit_res['rate_type']?></option>
<?}?>
</select>
...
<script>
    function EditOption(get_value_edit,trf_ID)
    {
        if(get_value_edit!="")
        {
            if(get_value_edit=="Zone")
            {
       window.location.href="manage-shipper-tariff.php?update_id="+trf_ID+"&edit_type=Zone";
            }
            
              if(get_value_edit=="State")
            {
         window.location.href="manage-shipper-tariff.php?update_id="+trf_ID+"&edit_type=State";
            }
            
              if(get_value_edit=="City")
            {
         window.location.href="manage-shipper-tariff.php?update_id="+trf_ID+"&edit_type=City";
            }
        }else{
            window.location.href="manage-shipper-tariff.php";  
        }
