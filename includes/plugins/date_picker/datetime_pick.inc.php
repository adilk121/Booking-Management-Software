...
?>
<input class="txtbox" type="text" name="<?=$jscal_input_name?>" id="<?=$jscal_input_name?>" size="18"  readonly value="<?=$jscal_def_date?>" <? if($validation!=''){?> alt="<?=$validation?>" emsg="<?=$validation_msg?>" <? }?>/> 
