...
document.getElementById("show_zone_textfield").innerHTML="<input type='number' name='tariff_basis_zone' id='tariff_basis_zone' value='<?=$res[tariff_basis_zone]?>' onkeyup='count_zone(this.value);' placeholder='Enter number of row(s) for zone rate' style='height:23px; width:230px;' onkeydown='return event.keyCode !== 69'>";
document.getElementById("show_zone_textfield_bulk").innerHTML="<input type='number' placeholder='Enter number of row(s) for bulk rate' style='height:23px; width:225px;' onkeydown='return event.keyCode !== 69'>";
count_state(0);
count_city(0);
...
document.getElementById("show_state_textfield").innerHTML="<input type='number' name='tariff_basis_state' id='tariff_basis_state' value='<?=$res[tariff_basis_state]?>' onkeyup='count_state(this.value);' placeholder='Enter number of row(s) for state rate' style='height:23px; width:230px;' onkeydown='return event.keyCode !== 69'>";
document.getElementById("show_state_textfield_bulk").innerHTML="<input type='number' placeholder='Enter number of row(s) for bulk rate' style='height:23px; width:225px;' onkeydown='return event.keyCode !== 69'>";
count_zone(0);
count_city(0);
...
document.getElementById("show_city_textfield").innerHTML="<input type='number' name='tariff_basis_city' id='tariff_basis_city' value='<?=$res[tariff_basis_city]?>' onkeyup='count_city(this.value);' placeholder='Enter number of row(s) for city rate' style='height:23px; width:230px;' onkeydown='return event.keyCode !== 69'>";
document.getElementById("show_city_textfield_bulk").innerHTML="<input type='number' placeholder='Enter number of row(s) for bulk rate' style='height:23px; width:225px;' onkeydown='return event.keyCode !== 69'>";
count_zone(0);
count_state(0);
...
?>
	...
	<td style="width:100px;"><p class=" p10px  ac" style="text-transform:uppercase; font-weight:bold; color:<?=$st_clr?>"><?=$res1['tariff_status']?></p></td>
		<td style="width:100px;"><p class=" p10px  ac">
		    <select name="edit_option" id="edit_option" onchange="EditOption(this.value,'<?=$res1[tariff_id]?>');">
		        <option value="">Edit <?=$res1['tariff_id']?></option>
		        <?php
		        $trf_Edit_sql=db_query("select distinct(rate_type) from tbl_tariff_rate where tariff_id='$res1[tariff_id]' ");
		        while($trf_Edit_res=mysql_fetch_array($trf_Edit_sql))
		        {
		        ?>
		        <option value="<?=$trf_Edit_res['rate_type']?>"><?=$trf_Edit_res['rate_type']?></option>
		        <?}?>
