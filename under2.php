...
<select name="per_name_t" id="per_name_t"     style="background:url(images/input_bg.gif) repeat-x; border:1px #CCCCCC solid; width:200px;height:25px;border-radius:4px;padding-top:5px;padding-bottom:5px;margin-top:5px;margin-bottom:5px;margin-left:5px;"  >
